 ...
 * File:   main.cpp
 * Author: Emma Wuysang
 * Created on January 28, 2024, 2:00 AM
 * Purpose: Concentration Card Game V.5
 */
...
//Function Prototypes
bool compareGuess(char,char,int,int&);
...
int main(int argc, char** argv) {
    ...
    while(gameSes=="y"){ // leads to loading screen   
        ...
        while(chce1 == 'y' && chce2 != "over"){
            ...
            cout<<card20<<endl<<endl;
            unsigned int moves = 0; // counter for amount of moves made
            bool complete = true; // initializes
            while(complete && chce2 != "over"){ //stops when pair is found
                cin>>userG1>>userG2; // users guess 1 and 2   
                
                // user guesses a b, b a
                if ((userG1=='a' && userG2=='b' && ((a-10)==b || (a+10)==b)) || (userG1=='b' && userG2=='a' && ((b-10)==a || (b+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd2<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // user guesses a c, c a
                else if ((userG1=='a' && userG2=='c' && ((a-10)==c || (a+10)==c)) || (userG1=='c' && userG2=='a' && ((c-10)==a || (c+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd3<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // user guesses a d, d a
                else if ((userG1=='a' && userG2=='d' && ((a-10)==d || (a+10)==d)) || (userG1=='d' && userG2=='a' && ((d-10)==a || (d+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd4<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // user guesses a e, e a
                else if ((userG1=='a' && userG2=='e' && ((a-10)==e || (a+10)==e)) || (userG1=='e' && userG2=='a' && ((e-10)==a || (e+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd5<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // user guesses a f, f a
                else if ((userG1=='a' && userG2=='f' && ((a-10)==f || (a+10)==f)) || (userG1=='f' && userG2=='a' && ((f-10)==a || (f+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd6<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a g, g a
                else if ((userG1=='a' && userG2=='g' && ((a-10)==g || (a+10)==g)) || (userG1=='g' && userG2=='a' && ((g-10)==a || (g+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd7<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a h, h a
                else if ((userG1=='a' && userG2=='h' && ((a-10)==h || (a+10)==h)) || (userG1=='h' && userG2=='a' && ((h-10)==a || (h+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd8<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a i, i a
                else if ((userG1=='a' && userG2=='i' && ((a-10)==i || (a+10)==i)) || (userG1=='i' && userG2=='a' && ((i-10)==a || (i+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd9<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // user guesses a j, j a
                else if ((userG1=='a' && userG2=='j' && ((a-10)==j || (a+10)==j)) || (userG1=='j' && userG2=='a' && ((j-10)==a || (j+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd10<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // user guesses a k, k a
                else if ((userG1=='a' && userG2=='k' && ((a-10)==k || (a+10)==k)) || (userG1=='k' && userG2=='a' && ((k-10)==a || (k+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd11<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a l, l a
                else if ((userG1=='a' && userG2=='l' && ((a-10)==l || (a+10)==l)) || (userG1=='l' && userG2=='a' && ((l-10)==a || (l+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd12<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a m, m a
                else if ((userG1=='a' && userG2=='m' && ((a-10)==m || (a+10)==m)) || (userG1=='m' && userG2=='a' && ((m-10)==a || (m+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd13<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a n, n a
                else if ((userG1=='a' && userG2=='n' && ((a-10)==n || (a+10)==n)) || (userG1=='n' && userG2=='a' && ((n-10)==a || (n+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd14<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}    

                // user guesses a o, o a
                else if ((userG1=='a' && userG2=='o' && ((a-10)==o || (a+10)==o)) || (userG1=='o' && userG2=='a' && ((o-10)==a || (o+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd15<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}    

                // user guesses a p, p a
                else if ((userG1=='a' && userG2=='p' && ((a-10)==p || (a+10)==p)) || (userG1=='p' && userG2=='a' && ((p-10)==a || (p+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd16<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a q, q a
                else if ((userG1=='a' && userG2=='q' && ((a-10)==q || (a+10)==q)) || (userG1=='q' && userG2=='a' && ((q-10)==a || (q+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd17<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}      

                // user guesses a r, r a
                else if ((userG1=='a' && userG2=='r' && ((a-10)==r || (a+10)==r)) || (userG1=='r' && userG2=='a' && ((r-10)==a || (r+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd18<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}        

                // user guesses a s, s a
                else if ((userG1=='a' && userG2=='s' && ((a-10)==s || (a+10)==s)) || (userG1=='s' && userG2=='a' && ((s-10)==a || (s+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd19<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // user guesses a t, t a
                else if ((userG1=='a' && userG2=='t' && ((a-10)==t || (a+10)==t)) || (userG1=='t' && userG2=='a' && ((t-10)==a || (t+10)==a))){cout<<"That was a pair!\n";
                   cout<<"You guessed the "<<newCd1<<" and "<<newCd20<<".\n"; cout<<"It took you "<<moves+1<<" move(s) to find the pair! \n";complete=false;score=moves+1;}

                // incorrect user guesses a b, b a
                else if ((userG1=='a' && userG2=='b' && ((a-10)!=b || (a+10)!=b)) || (userG1=='b' && userG2=='a' && ((b-10)!=a || (b+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='b'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd2<<".\n";}
                    else{cout<<"You guessed the "<<newCd2<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a c, c a
                else if ((userG1=='a' && userG2=='c' && ((a-10)!=c || (a+10)!=c)) || (userG1=='c' && userG2=='a' && ((c-10)!=a || (c+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='c'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd3<<".\n";}
                    else{cout<<"You guessed the "<<newCd3<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a d, d a
                else if ((userG1=='a' && userG2=='d' && ((a-10)!=d || (a+10)!=d)) || (userG1=='d' && userG2=='a' && ((d-10)!=a || (d+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='d'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd4<<".\n";}
                    else{cout<<"You guessed the "<<newCd4<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a e, e a
                else if ((userG1=='a' && userG2=='e' && ((a-10)!=e || (a+10)!=e)) || (userG1=='e' && userG2=='a' && ((e-10)!=a || (e+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='e'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd5<<".\n";}
                    else{cout<<"You guessed the "<<newCd5<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a f, f a
                else if ((userG1=='a' && userG2=='f' && ((a-10)!=f || (a+10)!=f)) || (userG1=='f' && userG2=='a' && ((f-10)!=a || (f+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='f'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd6<<".\n";}
                    else{cout<<"You guessed the "<<newCd6<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a g, g a
                else if ((userG1=='a' && userG2=='g' && ((a-10)!=g || (a+10)!=g)) || (userG1=='g' && userG2=='a' && ((g-10)!=a || (g+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='g'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd7<<".\n";}
                    else{cout<<"You guessed the "<<newCd7<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a h, h a
                else if ((userG1=='a' && userG2=='h' && ((a-10)!=h || (a+10)!=h)) || (userG1=='h' && userG2=='a' && ((h-10)!=a || (h+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='h'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd8<<".\n";}
                    else{cout<<"You guessed the "<<newCd8<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a i, i a
                else if ((userG1=='a' && userG2=='i' && ((a-10)!=i || (a+10)!=i)) || (userG1=='i' && userG2=='a' && ((i-10)!=a || (i+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='i'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd9<<".\n";}
                    else{cout<<"You guessed the "<<newCd9<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a j, j a
                else if ((userG1=='a' && userG2=='j' && ((a-10)!=j || (a+10)!=j)) || (userG1=='j' && userG2=='a' && ((j-10)!=a || (j+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='j'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd10<<".\n";}
                    else{cout<<"You guessed the "<<newCd10<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a k, k a
                else if ((userG1=='a' && userG2=='k' && ((a-10)!=k || (a+10)!=k)) || (userG1=='k' && userG2=='a' && ((k-10)!=a || (k+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='k'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd11<<".\n";}
                    else{cout<<"You guessed the "<<newCd11<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a l, l a
                else if ((userG1=='a' && userG2=='l' && ((a-10)!=l || (a+10)!=l)) || (userG1=='l' && userG2=='a' && ((l-10)!=a || (l+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='l'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd12<<".\n";}
                    else{cout<<"You guessed the "<<newCd12<<" and the "<<newCd1<<".\n";}moves+=1;}   

                // incorrect user guesses a m, m a
                else if ((userG1=='a' && userG2=='m' && ((a-10)!=m || (a+10)!=m)) || (userG1=='m' && userG2=='a' && ((m-10)!=a || (m+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='m'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd13<<".\n";}
                    else{cout<<"You guessed the "<<newCd13<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a n, n a
                else if ((userG1=='a' && userG2=='n' && ((a-10)!=n || (a+10)!=n)) || (userG1=='n' && userG2=='a' && ((n-10)!=a || (n+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='n'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd14<<".\n";}
                    else{cout<<"You guessed the "<<newCd14<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a o, o a
                else if ((userG1=='a' && userG2=='o' && ((a-10)!=o || (a+10)!=o)) || (userG1=='o' && userG2=='a' && ((o-10)!=a || (o+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='o'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd15<<".\n";}
                    else{cout<<"You guessed the "<<newCd15<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a p, p a
                else if ((userG1=='a' && userG2=='p' && ((a-10)!=p || (a+10)!=p)) || (userG1=='p' && userG2=='a' && ((p-10)!=a || (p+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='p'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd16<<".\n";}
                    else{cout<<"You guessed the "<<newCd16<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a q, q a
                else if ((userG1=='a' && userG2=='q' && ((a-10)!=q || (a+10)!=q)) || (userG1=='q' && userG2=='a' && ((q-10)!=a || (q+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='q'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd17<<".\n";}
                    else{cout<<"You guessed the "<<newCd17<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a r, r a
                else if ((userG1=='a' && userG2=='r' && ((a-10)!=r || (a+10)!=r)) || (userG1=='r' && userG2=='a' && ((r-10)!=a || (r+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='r'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd18<<".\n";}
                    else{cout<<"You guessed the "<<newCd18<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a s, s a
                else if ((userG1=='a'&& userG2=='s' && ((a-10)!=s || (a+10)!=s)) || (userG1=='s' && userG2=='a' && ((s-10)!=a || (s+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='s'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd19<<".\n";}
                    else{cout<<"You guessed the "<<newCd19<<" and the "<<newCd1<<".\n";}moves+=1;}

                // incorrect user guesses a t, t a
                else if ((userG1=='a' && userG2=='t' && ((a-10)!=t || (a+10)!=t)) || (userG1=='t' && userG2=='a' && ((t-10)!=a || (t+10)!=a))){cout<<"Not a pair.\n"; if(userG1=='a' && userG2=='t'){cout<<"You guessed the "<<newCd1<<" and the "<<newCd20<<".\n";}
...
bool compareGuess(char userG1,char userG2,int moves,int &score,char deck[]){
    bool complete;
    int SIZE = 20;
    char card[SIZE];
...
// goal - make a function to replace and finish most of the guesses.
