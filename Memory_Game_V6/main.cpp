 ...
 * Purpose: Concentration Card Game V.6
 */
...
//Function Prototypes
bool compareGuess(char,char,int,int &, char[], string[]);
    ...
    while(gameSes=="y"){ // leads to loading screen   
        ...
        while(chce1 == 'y' && chce2 != "over"){
            ...
            while(complete && chce2 != "over"){ //stops when pair is found
                ...
                compareGuess(userG1,userG2,moves,score,deck,cardNam);
            }
...
// worked on compare function, reads out cards in any order guessed now
bool compareGuess(char userG1,char userG2,int moves,int &score, char deck[], string cardNam[]){
    bool complete;
    int SIZE = 20;
